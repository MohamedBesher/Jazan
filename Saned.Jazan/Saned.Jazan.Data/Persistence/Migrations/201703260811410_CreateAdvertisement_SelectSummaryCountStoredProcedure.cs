namespace Saned.Jazan.Data.Migrations
{
    ...
    public partial class CreateAdvertisement_SelectSummaryCountStoredProcedure : DbMigration
    {
        public override void Up()
        {
            Sql(@"CREATE PROCEDURE [dbo].[Advertisement_SelectSummaryCount] 
    @CategoryId [int]
AS
BEGIN
...
END");
            ...
            Sql(@"Create PROCEDURE [dbo].[Advertisement_SelectPaging]
    @PageNumber [int],
    @PageSize [int],
    @CategoryId [int],
    @UserId [nvarchar](128),
...
BEGIN
	...
	(SELECT  
    STUFF((SELECT ', ' + CAST(AdvertisementImages.ImageUrl AS VARCHAR(250)) [text()]
...
END");
            ...
            Sql(@"CREATE PROCEDURE [dbo].[TouristVisit_SelectSummaryCount] 
...
END");
        ...
        {
            Sql(@"DROP PROCEDURE [dbo].[Advertisement_SelectSummaryCount]");
        }
    }
}
