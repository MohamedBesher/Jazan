namespace Saned.Jazan.Data.Migrations
{
    ...
    public partial class CreateTouristVisitsSP : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure("TouristVisit_SelectPaged", p => new
            {
                PageNumber = p.Int(),
                PageSize = p.Int(),
            ...
            CreateStoredProcedure("TouristVisit_SelectById", P => new { Id = P.Int() }, @"DECLARE @results VARCHAR(MAX)
        ...
        {
            DropStoredProcedure("TouristVisit_SelectPaged");

            DropStoredProcedure("TouristVisit_SelectById");
        }
    }
}
