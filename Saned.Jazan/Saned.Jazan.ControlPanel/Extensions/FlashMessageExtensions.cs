...
namespace Saned.Jazan.ControlPanel.Extensions
{
    internal static class FlashMessageExtensions
    {
        ...
        {
            HttpContext.Current.Response.Cookies.Add(new HttpCookie(string.Format("Flash.{0}", notification), HttpUtility.UrlEncode(message, Encoding.UTF8)) { Path = "/" });
        }
